...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/15 15:25:31 by tdawson           #+#    #+#             */
/*   Updated: 2022/01/26 20:52:31 by tdawson          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*ft_ftoa(long double value, unsigned int precision);
...
long				ft_pow(double base, double exponent);
